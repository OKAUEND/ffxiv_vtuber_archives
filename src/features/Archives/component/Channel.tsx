...
export const Channel = ({ channelDetail }: IProps) => {
    return (
        <div className="grid grid-cols-3 grid-rows-2 w-6/12">
            <div className="col-span-1 row-span-3 grid md:justify-items-end mr-3">
                <IconElement
            ...
            <div className="col-span-2 row-span-2 flex flex-row">
